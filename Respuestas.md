...
Siempre se cumple $0 \le \text{\size} \le \text{\capacity}$. Además, todos los índices $0 \le i < \text{\size}$ en \_elem contienen objetos lógicos válidos y \_elem apunta a un bloque de memoria que aloja exactamente \_capacity espacios (continuo).
